            ...
            <form action="">
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        ...
                        <input placeholder='Jhon Doe' type="text" name="name" />
                        <div className="tooltip"><AlertCircle/><p> Enter Your Full name</p></div>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-col-25">
                        <label htmlFor="currentjob">D.O.B </label>
                        <input type="date" name="currentjob" />
                    ...
                    <div className="form-col-25">
                        <label htmlFor="name">Languages Known</label>
                        <input placeholder='English, Hindi etc.' type="text" name="name" />

                    </div>
                </div>
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">About You</label>
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="education">Email Address</label>
                        <input placeholder='Jhondoe@gmail.com' type="email" name="education" />
                ...
                <div className="form-row">
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="currentjob">Mobile No.</label>
                        <input placeholder='+91 6666666666' type="text" name="currentjob" />
                        <div className="tooltip"><AlertCircle/><p>For office use and for scheduling call</p></div>

                    </div>
                    <div className="form-col-50">
                        <label htmlFor="education">City Country</label>
                        <input placeholder='eg. Mumbai,India' type="text" name="education" />
                    </div>
                </div>
                ...
                <div className="form-row">
                    <div className="form-col-50 has-tooltip">
                        ...
                        <input placeholder='Job Role or Position ,company' type="text" name="currentjob" />
                    ...
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="currentjob">Experience</label>
                        <input placeholder='Job Role or Position ,company' type="text" name="currentjob" />
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        ...
                        <input placeholder='Degree , specialization, college/university' type="text" name="education" />
                        <div className="tooltip"><AlertCircle/><p>Ex: B.Com, M.Phil, PHD, CA, Dr. (+) Branch/ Specialization (+) College/ Institute name, City</p></div>
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="education">Skills/ Professional Fields </label>
                        <input placeholder='eg. App Development, Painting,' type="text" name="education" />
                    ...
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="education">Achievements </label>
                        <input placeholder='Awards, Recognition, Rank' type="text" name="education" />
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">What do you feel about 1dot1? *</label>
                        <textarea name="" id="" rows="5"></textarea>
                ...
                <div className="form-row">
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="education">Preferred Time for Mentoring </label>
                        <input placeholder='eg.7pm-8pm weekends' type="text" name="education" />
                    ...
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="education">Expected Mentorship Fee</label>
                        <input placeholder='eg. Rs 200' type="text" name="education" />
                ...
                {method === '1' && <div className="form-row">
                    <div className="form-col-50">
                        <label htmlFor="education">UPI ID</label>
                        <input placeholder='eg. abc@ok.sbi' type="text" name="education" />
                    </div>
                </div>}
                    ...
                    method === '2' && <>
                        <div className="form-row">
                            <div className="form-col-100">
                                <label htmlFor="education">Account No.</label>
                                <input placeholder='Your 16 digit Acc. No.' type="text" name="education" />
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-col-50">
                                <label htmlFor="education">Full Name</label>
                                <input placeholder='eg. Jhon Doe' type="text" name="education" />
                            </div>
                            <div className="form-col-50">
                                <label htmlFor="education">IFSC code</label>
                                <input placeholder='' type="text" name="education" />
                            </div>
                        </div>
                    </>
                }
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">LinkedIn Profile Link</label>
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">Instagram Profile Link</label>
                        <input type="text" name="Subject" />
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">Facebook Profile Link</label>
                        <input type="text" name="Subject" />
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">Twitter Profile Link</label>
                        <input type="text" name="Subject" />
                ...
                <div className="form-row">
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="education">Photograph</label>
                    ...
                    <div className="form-col-50 has-tooltip">
                        <label htmlFor="education">Resume</label>
                        <input placeholder='' type="file" name="education" />
                ...
                <div className="form-row">
                    <div className="form-col-100 has-tooltip">
                        <label htmlFor="Subject">If we missed anything!!!</label>
                        <input type="text" name="Subject" />
